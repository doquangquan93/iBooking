...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'iBooking'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; iBooking by <a href="https://martmbithi.github.io" target="_blank">MartDevelopers </a>
                    </div>
                    <div class="col-md-6">
