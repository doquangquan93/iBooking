...
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text"><a href="<?php echo e(url('/admin')); ?>">iBooking <span><?php echo e(config('app.version')); ?></span></a></h3>
</div>
...
<?php /**PATH /opt/lampp/htdocs/booking-core/resources/views/admin/layouts/parts/header.blade.php ENDPATH**/ ?>