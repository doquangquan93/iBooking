...
<head>
    ...
    <title><?php echo e($page_title ?? 'Dashboard'); ?> - <?php echo e(setting_item('site_title') ?? 'iBooking'); ?></title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; iBooking by <a href="https://martmbithi.github.io" target="_blank">MartDevelopers </a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="https://martmbithi.github.io" target="_blank">About Us</a>
                            <a href="https://martmbithi.github.io" target="_blank">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /opt/lampp/htdocs/booking-core/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>